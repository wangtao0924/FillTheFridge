...
namespace MPStudio
{
    ...
    public static class MPMsg
    {
        ...
        public static void On(string msgStr, DGCustomMessage callback, object target)
        {
        ...
        public static void Once(string msgStr, DGCustomMessage callback, object target)
        {
        ...
        private static void AddMessageHandler(object target, string msgStr, DGCustomMessage callback, bool once)
        {
            ...
            {
                MPLOG.E("msg", $"error msg type is {msgStr}");
                return;
            }

            if (callback == null)
            {
                MPLOG.E("msg", "none call back!!");
                return;
            }
